    ...
    <Modal visible={props.modalVisible}>
        <View style={modal.centeredView}>
            <View style={modal.modalView}>
                <TextInput  style={styles.index} placeholder="姓名" value={name} onChangeText={text=>setName(text)}/>
                <TextInput  style={styles.index} placeholder="城市" value={city} onChangeText={text=>setCity(text)}/>
                <TextInput  style={styles.index} placeholder="年齡" value={age} onChangeText={text=>setAge(text)}/>
